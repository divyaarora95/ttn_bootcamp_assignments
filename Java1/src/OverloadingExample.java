...
public class OverloadingExample
{
    public static void main(String[] args) {
        ...
        System.out.println("concatenating two strings: " +obj1.concatenate("Divya", "Arora"));
        System.out.println("concatenating two strings: " +obj1.concatenate("Hello", "Divya", "Arora"));
