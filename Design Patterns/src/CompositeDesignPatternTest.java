...
public class CompositeDesignPatternTest {
    public static void main(String[] args) {
        JVMDeveloper jvmDeveloper1 = new JVMDeveloper("Drishti", 1);
        jvmDeveloper1.showDirectoryDetails();
        
        JVMDeveloper jvmDeveloper2 = new JVMDeveloper("Nisha", 2);
        jvmDeveloper2.showDirectoryDetails();
        
        AMCDeveloper amcDeveloper1 = new AMCDeveloper("Shruti", 3);
        amcDeveloper1.showDirectoryDetails();
        
        AMCDeveloper amcDeveloper2 = new AMCDeveloper("Vani", 4);
